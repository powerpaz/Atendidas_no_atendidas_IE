...
// Fallbacks (por si en el repo el TopoJSON quedó con nombre original)
window.CANTONES_NBI_FALLBACK = [
  'data/cantones_nbi_mayor_50.topo.json',
  'data/Cantones con NBI mayor al 50_.json'
];
